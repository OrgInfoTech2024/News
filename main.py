    ...
    def load_news(self):
        ...
        if response.status_code == 200:
            ...
            if articles:
                ...
                self.news_label.setText(self.lang[self.syslang]["No news articles available"])
        else:
            self.news_label.setText(self.lang[self.syslang]["Failed to fetch news. Please try again later"])
